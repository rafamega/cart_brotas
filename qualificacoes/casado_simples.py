...
def criar_qualificacao_casado_simples(dados, caminho):
    doc = Document()
    ...
    # Casado com
    run = p.add_run(f"{dados['casad']} com ")
    run.italic = True
    ...
    p.add_run(
        f", {dados['nacionalidade_conjuge']}, {dados['profissao_conjuge']}, {dados['portad_conjuge']} da "
    )
...
# ENTRADA INTERATIVA ==========================================================
def pergunta_dados_casado_simples():
    ...
    txt_pacto = (
        ...
        f"às fls. ___, aos _________, e que foi registrado sob n. ______, livro 3, "
